...
const roleSchema = new mongoose.Schema({
  ...
  email: { type: String, required: true, unique: true }, // changed from emailId to email
  contactNumber: { type: String, required: true },
  password: { type: String, required: true },
  isActive: { type: Boolean, default: true },
  role: { type: String, required: true },
  accessRights: {
    billing: { type: accessSectionSchema, default: {} },
    tools: { type: accessSectionSchema, default: {} },
    wallet: { type: accessSectionSchema, default: {} },
    accounts: { type: accessSectionSchema, default: {} },
    settings: { type: accessSectionSchema, default: {} },
