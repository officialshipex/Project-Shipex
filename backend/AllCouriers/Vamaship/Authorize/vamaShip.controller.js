...
const USERNAME = process.env.VAMASHIP_USERNAME;
const PASSWORD = process.env.VAMASHIP_PASSWORD;
...
const saveVamaship = async (req, res) => {
...
module.exports = { getAccessToken, saveVamaship };
