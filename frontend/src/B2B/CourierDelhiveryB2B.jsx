                    ...
                    <div className="flex-1 flex flex-col p-4 space-y-6 bg-gray-50 overflow-y-auto">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                            ...
                            <div className="bg-white p-4 md:p-6 shadow-lg rounded-lg">
                                <h2 className="text-lg font-bold mb-2">Delhivery</h2>
                                <p className="text-sm mb-2 font-semibold">
                                    Use the following instructions to integrate your Delhivery Account Credentials:
                                </p>
                                <p className="text-sm mb-2 font-semibold">
                            ...
                            <div className="col-span-2 space-y-4">
                                ...
                                <div className="bg-white p-4 md:p-6 shadow-lg rounded-lg">
                                    ...
                                    <p className="text-gray-600 text-sm mb-4">
                                        Please provide below given Credentials for Delhivery
                                    </p>
...
export default CourierDelhiveryB2B;
