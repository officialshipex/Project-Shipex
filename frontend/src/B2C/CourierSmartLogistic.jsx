                    ...
                    <div className="flex-1 flex flex-col p-4 space-y-6 bg-gray-50 overflow-y-auto">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                            ...
                            <div className="bg-white p-4 md:p-6 shadow-lg rounded-lg">
                                <h2 className="text-lg font-bold mb-2">Smart Logistics</h2>
                                <p className="text-sm mb-2 font-semibold">
                                    Use the following instructions to integrate your Smart Logistics Account Credentials:
                                </p>
                                <p className="text-sm mb-2 font-semibold">
                            ...
                            <div className="col-span-2 space-y-4">
                                ...
                                <div className="bg-white p-4 md:p-6 shadow-lg rounded-lg">
                                    ...
                                    <p className="text-gray-600 text-sm mb-4">
                                        Please provide below given Credentials for Smart Logistics
                                    </p>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {[
                                            { label: 'Device ID', type: 'text', placeholder: 'Device ID' },
                                            { label: 'Agent Code', type: 'text', placeholder: 'Agent Code' },
                                            { label: 'Client Key', type: 'text', placeholder: 'Client Key' },
                                            { label: 'Client Uid', type: 'text', placeholder: 'Client Uid' },
                                            { label: 'Login Name', type: 'text', placeholder: 'Login Name' },
                                            { label: 'Shipper Code', type: 'text', placeholder: 'Shipper Code' }
...
export default CourierSmartLogistic;
