                    ...
                    <div className="flex-1 flex flex-col p-4 space-y-6 bg-gray-50 overflow-y-auto">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                            ...
                            <div className="bg-white p-4 md:p-6 shadow-lg rounded-lg">
                                <h2 className="text-lg font-bold mb-2">Blue Dart Surface</h2>
                                <p className="text-sm mb-2 font-semibold">
                                    {`Use the following instructions to integrate your Blue Dart Surface Account Credentials:`}
                                </p>
                                <p className="text-sm mb-2 font-semibold">
                                ...
                                <ul className="text-sm list-disc ml-4 mb-2 border-b pb-6">
                                    ...
                                    <li>License Key</li>
                                    <li>Service type</li>
                                    <li>Origin Area code</li>
                                    <li>COD Customer code</li>
                                    <li>Prepaid Customer Code</li>
                                    <li>Tracking License Key</li>
                                </ul>
                            ...
                            <div className="col-span-2 space-y-4">
                                ...
                                <div className="bg-white p-4 md:p-6 shadow-lg rounded-lg">
                                    ...
                                    <p className="text-gray-600 text-sm mb-4">
                                        Please provide below given Credentials for Blue Dart Surface 10kg
                                    </p>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {[
                                            { label: 'Login ID', type: 'text', placeholder: 'Login ID' },
                                            { label: 'License Key', type: 'text', placeholder: 'License Key' },
                                            { label: 'Service type', type: 'text', placeholder: 'Service type' },
                                            { label: 'Origin Area code', type: 'text', placeholder: 'Origin Area code' },
                                            { label: 'COD Customer code', type: 'text', placeholder: 'COD Customer code' },
                                            { label: 'Prepaid Customer Code', type: 'text', placeholder: 'Prepaid Customer Code' },
                                            { label: 'Tracking License Key', type: 'text', placeholder: 'Tracking License Key' },
...
export default CourierBlueDart;
