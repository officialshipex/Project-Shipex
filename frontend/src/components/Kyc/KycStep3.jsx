...
const KycStep3 = () => {
  ...
  const handleOptionChange = (option) => {
    ...
    if (option === "digital") {
      // navigate("/digital-kyc"); // Navigate to the Digital KYC page
    }
  };
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-white px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="w-full max-w-screen-lg xl:max-w-screen-xl p-6 lg:p-0 flex flex-col lg:flex-row items-center justify-center lg:justify-start lg:ml-[300px] lg:mt-[-250px] mt-0">
        ...
        <div className="w-full lg:w-1/2 space-y-4">
          ...
          {/* Options */}
          <h3 className="text-base sm:text-lg font-semibold text-gray-800">Verify Your ID</h3>
          <div className="space-y-4">
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <span className={`text-${selectedOption === "digital" ? "green-500" : "gray-800"}`}>Digital KYC</span>
              </div>
              <span className="text-sm text-gray-500 ml-12">Instant Activation</span>
            </button>
            ...
            >
              ...
              <span className="text-sm text-gray-500 ml-3">(Takes 24 to 48 Hours)</span>
            </button>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 mt-6 lg:mt-72 lg:mr-0 flex flex-col items-center lg:items-start"> 
          ...
          <div className="flex justify-center lg:justify-start w-full mt-6"> 
            <button
              className="px-8 sm:px-16 py-2 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 focus:ring-2 focus:ring-offset-2 focus:ring-green-500 mt-6 sm:mt-12 ml-40" // Added ml-4 for slight left movement
            >
              Next
            </button>
          </div>
