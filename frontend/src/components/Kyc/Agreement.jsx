...
const Agreement = (props) => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen px-4 sm:px-6 lg:px-8 overflow-x-hidden">
      <div className="w-full max-w-5xl p-4 sm:p-6 mt-6 mx-auto">
        <img
          src={Logo}
          alt="ShipEx Logo"
          className="mx-auto h-6 sm:h-10 ml-1"
        />
        ...
        <div className="bg-gray-50 border border-green-200 p-6 sm:p-4 rounded-lg shadow-inner space-y-4 mt-5 sm:mt-7 max-w-full mx-auto min-h-[300px] sm:min-h-[400px] lg:min-h-[300px]">
          <p className="text-xs sm:text-sm text-gray-700 leading-relaxed ">
            Nemo autem repudiandae fuga. Ad tenetur mollitia. Itaque natus aut
            nobis accusantium sequi officia labore qui dolor. Odit quia officiis
            accusamus vitae non laboriosam quo velit. Suscipit sit fugiat et
            non. Iure adipisci animi et reiciendis perferendis ut illo rerum
            possimus. Sit quidem porro sunt porro dolorem tempora est
            perferendis amet. Labore aliquid adipisci rerum vel. Odio iure
            voluptatem illo.
          </p>
          <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">
            Dicta molestias ut velit. Nulla fugit quod nisi facere at sed quae
            perspiciatis. Maiores quisquam ipsam fugit quam laborum vero maxime
            voluptatem. Aliquam nemo ullam corrupti tempor.
          </p>
          ...
          <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">
            Dicta molestias ut velit. Nulla fugit quod nisi facere at sed quae
            perspiciatis. Maiores quisquam ipsam fugit quam laborum vero maxime
            voluptatem. Aliquam nemo ullam corrupti tempora minus officia dolor
            magnam eos. Inventore autem ipsum quia inventore sit repellendus
            quia velit animi. Aut sed illo non voluptatem.
          </p>
          ...
          <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">
            Dicta molestias ut velit. Nulla fugit quod nisi facere at sed quae
            perspiciatis. Maiores quisquam ipsam fugit quam laborum vero.
          </p>
